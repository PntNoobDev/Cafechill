...
$offset = ($page - 1) * $productsPerPage; // Tính vị trí bắt đầu
...
try {
    ...
    $query = "SELECT * FROM SanPham LIMIT :offset, :limit";
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="add_wrapper my-3">
                <a href="add_sanpham.php" class="btn btn-primary btn-lg">Thêm Sản Phẩm</a>
            </div>
                    ...
                    <?php if (!empty($products)): ?>
                        <?php foreach ($products as $product): ?>
                            <tr>
                                ...
                                <td><?php echo $product['TrangThai'] === 'ConHang' ? 'Còn hàng' : 'Hết hàng'; ?></td>
                                <td>
                                    <a href="edit_sanpham.php?id=<?php echo $product['SanPhamID']; ?>" class="btn btn-sm btn-warning">Sửa</a>
                                    <a href="delele_sanpham.php?id=<?php echo $product['SanPhamID']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');">Xóa</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
